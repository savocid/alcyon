...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    if (!(gPlayerAvatar.flags & PLAYER_AVATAR_FLAG_UNDERWATER) && ((heldKeys & B_BUTTON) || gSaveBlock2Ptr->optionsAlwaysRun == TRUE) && FlagGet(FLAG_SYS_B_DASH)
