...
#define B_WILD_QUICK_RUN            TRUE  // If set to TRUE, pushing B in the battle options against a wild encounter will move the cursor to the run option on first input and press it on second input (or press it on first if already hovered)
